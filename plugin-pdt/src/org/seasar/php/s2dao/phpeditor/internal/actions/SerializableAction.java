...
import org.seasar.php.s2dao.core.creator.php.SerializableCreator;
 ...
 * @author nowel
 */
public class SerializableAction implements ICreatorAction {
    public ICreator createNewPHPCreator(PHPStructuredEditor editor, IPHPStructure structure) {
        return new SerializableCreator(PHPEditorUtils.getCodeFormat(editor), structure);
    }
}
